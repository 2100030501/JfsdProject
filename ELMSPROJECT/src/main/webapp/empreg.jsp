...
<div class="box">
        <form  action="insertemp" method="post" enctype="multipart/form-data">
            ...
            <div class="inputBox">
             ...
             <div class="inputBox">
                <input type="email" name="email" pattern="^(.+@gmail\.com$|.+@yahoo\.com$)$" placeholder="Enter a valid email address"  required/>
                <span>Email</span>
                <i></i>
            </div>
            ...
            <div class="inputBox">
                <input type="password" name="pwd" pattern="^(?=.*[a-z])(?=.*[A-Z])(?=.*\d)(?=.*[@$!%*?&])[A-Za-z\d@$!%*?&]{8,}$"	 required/>
                <span>Password</span>
                <i></i>
            </div>
            <div class="inputBox">
